...
Z([3,'vue-ref'])
Z([1,true])
Z([[4],[[5],[[4],[[5],[[5],[1,'^closeCallback']],[[4],[[5],[[4],[[5],[1,'closeCallback']]]]]]]]])
Z([3,'loading'])
Z([3,'250rpx'])
Z([1,false])
Z(z[7])
...
var x=['./components/xuan-loading/xuan-loading.wxml','./pages/index/index.wxml'];d_[x[0]]={}
var m0=function(e,s,r,gg){
var z=gz$gwx_1()
var oB=_mz(z,'view',['class',0,'hidden',1],[],e,s,gg)
var xC=_mz(z,'view',['bindtap',2,'class',1,'data-event-opts',2,'hidden',3],[],e,s,gg)
_(oB,xC)
var oD=_mz(z,'view',['class',6,'style',1],[],e,s,gg)
var fE=_n('slot')
_(oD,fE)
var cF=_mz(z,'view',['class',8,'hidden',1],[],e,s,gg)
var hG=_n('view')
...
var fS=_mz(z,'button',['bindtap',1,'data-event-opts',1],[],e,s,gg)
var cT=_oz(z,3,e,s,gg)
_(fS,cT)
_(oR,fS)
var hU=_mz(z,'loading',['bind:__l',4,'bind:closeCallback',1,'class',2,'custom',3,'data-event-opts',4,'data-ref',5,'height',6,'maskClick',7,'maskShow',8,'type',9,'vueId',10,'vueSlots',11],[],e,s,gg)
var oV=_n('view')
